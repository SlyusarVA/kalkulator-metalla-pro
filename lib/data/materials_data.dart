...
// Порядок групп металлов — по объёму в остатках склада (от большего к меньшему).
// Группы без остатков — в конце, по алфавиту.
//
// Марки стали — по убыванию плотности:
//   Быстрорежущие (8150–8700) → Инструментальные (7830) → Легированные (7850)
//   → Пружинные (7850) → Конструкционные (7850) → Автоматные (7850)

const List<MetalMaterial> materials = [

  // ── СТАЛЬ (самая большая группа на складе) ──────────────────────────────────
  // Быстрорежущие — наибольшая плотность
  ...
  // Конструкционные углеродистые обыкновенного качества
  ...
  // ── Остальные (редкие на складе) — по алфавиту ──────────────────────────────
...
// Порядок групп по объёму склада — используется в барабане
const List<String> _groupOrder = [
  'Сталь', 'Нержавейка', 'Алюминий', 'Латунь', 'Медь', 'Бронза',
...
List<String> get metalGroups {
  ...
  // Если вдруг появятся новые группы — добавим в конец
